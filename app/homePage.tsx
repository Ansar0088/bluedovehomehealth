...
import { ArrowRight, ChevronRight, ChevronUp, MenuIcon, X } from "lucide-react";
  ...
  return (
    <div className=" bg-white">
      ...
      className={`sticky top-0 z-50 transition-all duration-300 ${
        window.scrollY > 0 ? "shadow-md bg-white/95 backdrop-blur-sm py-2" : "py-4 bg-white"
      }`}
    >
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 lg:py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5">
            <div className="bg-blue-800 rounded-lg p-6 md:p-8 shadow-lg">
